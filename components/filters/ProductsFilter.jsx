...
const ProductsFilter = ({isFilterOpen, setIsFilterOpen, applyFilter, handleManipulateCategoriesArray}) => {
	...
	return (
		<div className={`${!isFilterOpen? 'hidden' : 'block'} min-w-[310px] xl:w-[380px] absolute top-12 bg-white shadow-2xl z-10 p-6 rounded-xl`}>
			<div className='w-full'>
				...
				<div className="flex items-center my-4">
					<input
						...
						type="checkbox" id="category-acai" name="category-product-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus-visible:outline-none focus-visible:border-none"/>
				...
				<div className="flex items-center my-4">
					<input
						...
						type="checkbox" id="category-pitaya" name="category-product-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus-visible:outline-none focus-visible:border-none"/>
				...
				<div className="flex items-center my-4">
					<input
						...
						type="checkbox" id="category-granola" name="category-product-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus-visible:outline-none focus-visible:border-none"/>
				...
				<div className="flex items-center my-4">
					<input
						...
						type="checkbox" id="category-dry-goods" name="category-product-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus-visible:outline-none focus-visible:border-none"/>
				...
				<div className="flex items-center my-4">
					<input
						...
						type="checkbox" id="category-organic-iqf" name="category-product-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus-visible:outline-none focus-visible:border-none"/>
				...
				<div className="flex items-center my-4">
					<input
						...
						type="checkbox" id="category-conventional-iqf" name="category-product-radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus-visible:outline-none focus-visible:border-none"/>
